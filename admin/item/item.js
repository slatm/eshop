...
function del(iid){
    $.post('admin/item/delete.php', {iid:iid}, function(data) {
                    alert(data);
        search();
        },'text');
}
...
function search(condition){
    ...
    $.get('admin/item/listitem.php', condition|| {},function(data){
        $.each(data, function(idx,obj){
            var tr = [
                ...
                "<td><a href=\"javascript:del('" + obj.iid + "')\">删除</a></td>",
                "</tr>"
            ];
